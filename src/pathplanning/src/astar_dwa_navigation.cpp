...
private:
    ...
    struct Config {
        ...
        std::string global_path_topic = "/global_plan";
        std::string local_path_topic = "/local_path";
        std::string astar_path_topic = "/astar_path";
    } config_;
...
public:
    FixedAStarDWANavigation() :
        ...
        ROS_INFO("=== Fixed A* + DWA Navigation System ===");
...
private:
    ...
    void initializeParameters() {
        ...
        config_.global_path_topic = "/global_plan";
        config_.local_path_topic = "/local_path";
        config_.astar_path_topic = "/astar_path";
    ...
    void initializePlanners() {
        ...
        try {
            ...
            ROS_FATAL("Failed to initialize DWA planner. %s", e.what());
            throw;
        }
    }
    ...
    void initializeROS() {
        ...
        marker_pub_ = nh_.advertise<visualization_msgs::MarkerArray>("/navigation_markers", 1, true);
    }
...
int main(int argc, char** argv) {
    ros::init(argc, argv, "astar_dwa_navigation");
